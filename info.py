...
STREAM_SITE = (environ.get('STREAM_SITE', 'kingurl.in'))
STREAM_API = (environ.get('STREAM_API', '52fc11e73a9d9da5ed673830b55ca9c252dda348'))
...
URL = "https://myd-lvx5.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://myd-lvx5.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://myd-lvx5.onrender.com/".format(FQDN)
else:
    URL = "https://myd-lvx5.onrender.com/".format(FQDN)
