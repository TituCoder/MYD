...
STREAM_SITE = (environ.get('STREAM_SITE', 'api.shareus.io/easy_'))
...
# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.shareus.io/easy_')
...
URL = "https://titu.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://titu.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://titu.koyeb.app/".format(FQDN)
else:
    URL = "https://titu.koyeb.app/".format(FQDN)
